...
cfg_if! {
    if #[cfg(any(
        ...
        extern "C" {}
    } else if #[cfg(target_os = "nagi")] {
        // Nagi provides the user-space C ABI in its own runtime.  The libc
        // bindings must not inject a host or foreign OS library dependency.
    } else if #[cfg(target_os = "aix")] {
        #[link(name = "c")]
        #[link(name = "m")]
        #[link(name = "bsd")]
...
extern "C" {
    ...
    pub fn setgroups(ngroups_max: c_int, groups: *const gid_t) -> c_int;
