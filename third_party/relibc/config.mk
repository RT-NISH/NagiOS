...
ifeq ($(TARGET),x86_64-unknown-nagi-user)
	# The Nagi C ABI header build still renames symbols in the Rust archive.
	# Use the pinned LLVM binutils used by the Nagi target, never host MSVC or
	# an implicitly selected system object tool.
	export NM=llvm-nm
